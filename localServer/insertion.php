...
<header>
  ...
  <?php
    ...
    //ADDING DATA to the database
      ...
      if(!$conn){
        ...
        $sql = "INSERT INTO `vc_student` (`roll_no`, `name`, `email`, `phone_no`, `time_of_entry`) VALUES ('$roll_no', '$name', '$email', '$phone_no', current_timestamp())";
        ...
        try{
          ...
          echo ' <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success!</strong> The data has been successfully inserted into the database.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div> ';
        }
        catch(Exception $e){
          echo ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Error!</strong> The data has <strong>NOT</strong> been successfully inserted into the database.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div> ';
        }
  ...
  <div
    ...
    <hr />
    <form action="/RR/insertion.php" method="post">
      <div class="mb-3">
